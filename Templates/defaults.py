...
'img_size' : 'auto', # The size of the image rendered if 'auto' is chosen the image will be 950x950 for calibration and 650x650 for a movie | ['auto', ['int', 'int'] | 'not-tested'
## File Handling
